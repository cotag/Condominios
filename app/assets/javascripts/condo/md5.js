...
(function (factory) {
    ...
    /**
      ...
      * @return {String|Array} The result
      */
    SparkMD5.hash = function (options) {
        ...
        if(!!options.string){
	        if (/[\u0080-\uFFFF]/.test(options.string)) {
	            str = unescape(encodeURIComponent(options.string));
	        }
	
	        hash = md51(options.string);
        } else {
        	hash = md51(options.content);
        }

        return !!options.raw ? hash : hex(hash);
    };
